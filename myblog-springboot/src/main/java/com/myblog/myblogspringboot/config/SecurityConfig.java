    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/friend-links/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/v1/friend-links/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/friend-links/**").hasRole("ADMIN")
