...
// ── 反向代理信任 ──
// 请求经 Nuxt(3001)/Nginx 反代转发，必须按 X-Forwarded-For 取真实客户端 IP，
// 否则限流会将所有访客视为同一 IP（127.0.0.1），导致误杀正常浏览。
// 生产多级代理时可调整 TRUST_PROXY（代理层数），0 = 关闭。
...
app.use(`${apiPrefix}/friend-links`, friendLinkRoutes);
